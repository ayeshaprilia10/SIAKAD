        ...
        <div class="box box-success box-solid">
            ...
            <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <input name="kode_prodi" placeholder="Kode Program Studi" type="text"class="form-control">
                </div>
                <div class="form-group">
                    <label>Program Studi</label>
                    <input name="prodi" placeholder="Program Studi" type="text"class="form-control">
                </div>
                <div class="form-group">
                    <label>Program Studi</label>
