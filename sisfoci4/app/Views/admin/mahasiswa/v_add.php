        ...
        <div class="box box-success box-solid">
            ...
            <?php } ?>
                ...
                <div class="form-group">
                    ...
                    <input name="nama_mhs" placeholder="Nama Mahasiswa" type="text"class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <img src="<?= base_url('fotomhs/default.png') ?>" id="gambar_load" width="200px" height="200px" alt="">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
